...
<body>
    <div class="container-fluid fixed-top p-4 bg-white">
        ...
        <div class="container-fluid p-5 mt-5">
            <h5 class="text-center fw-bold fs-2">Nuestros <strong class="text-danger">Proveedores</strong></h5>
            <div class="row">
                <?php $cnt = 1; ?>
                    ...
                    <div class="col-4">
                        <div class="card mt-3 mb-3 bg-dark text-white">
                            ...
                            <div class="card-body text-center">
                                <p class="card-title fw-bold fs-4">{{ $provider->name }}</p>
                                <p class="card-text">
                                    <button type="button" id="{{ $cnt }}" class="btn btn-light"
                                        data-toggle="modal" onclick="showProviders({{ $provider->id }})">
                                        ver más </button>
                                </p>
                            </div>
                        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="providerModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">

                <div class="modal-content p-4">
                    <div class="modal-header">
                        <img id="logo" src="" class="card-img-top img-fluid rounded mx-auto d-block m-3"
                            style="width: 17rem;">
                    </div>
